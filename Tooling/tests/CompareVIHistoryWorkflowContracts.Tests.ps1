...
Describe 'CompareVI History workflow contracts' {
    ...
    It 'adds a thin automatic PR diagnostics wrapper pinned to an immutable comparevi-history ref' {
        ...
        $script:automaticPrWorkflow | Should -Match 'uses:\s+LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/pull-request-diagnostics-auto\.yml@v1\.3\.11'
        ...
        $script:automaticPrWorkflow | Should -Match 'platform_ref:\s+v1\.3\.11'
    ...
    It 'adds a thin automatic PR publication wrapper pinned to the same immutable comparevi-history ref' {
        ...
        $script:automaticPrPublishWorkflow | Should -Match 'uses:\s+LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/pull-request-diagnostics-publish\.yml@v1\.3\.11'
        ...
        $script:automaticPrPublishWorkflow | Should -Match 'platform_ref:\s+v1\.3\.11'
    ...
    It 'adds a thin agent-canary evaluation wrapper pinned to the same immutable comparevi-history ref' {
        ...
        $script:agentCanaryWorkflow | Should -Match 'uses:\s+LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/pull-request-diagnostics-canary-evaluate\.yml@v1\.3\.11'
        ...
        $script:agentCanaryWorkflow | Should -Match 'platform_ref:\s+v1\.3\.11'
    ...
    It 'documents the target catalog and action-owned public outputs' {
        ...
        $script:docs | Should -Match 'LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/pull-request-diagnostics-auto\.yml@v1\.3\.11'
        $script:docs | Should -Match 'LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/pull-request-diagnostics-publish\.yml@v1\.3\.11'
        $script:docs | Should -Match 'LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/pull-request-diagnostics-canary-evaluate\.yml@v1\.3\.11'
        $script:docs | Should -Match 'LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/manual-vi-exploration\.yml@v1\.3\.7'
        $script:docs | Should -Match 'LabVIEW-Community-CI-CD/comparevi-history@v1\.3\.11'
