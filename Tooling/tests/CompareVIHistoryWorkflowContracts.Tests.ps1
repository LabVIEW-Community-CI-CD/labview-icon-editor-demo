...
Describe 'CompareVI History workflow contracts' {
    ...
    It 'adds a thin manual exploration wrapper pinned to the published reusable workflow' {
        ...
        $script:manualExplorationWorkflow | Should -Match 'uses:\s+LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/manual-vi-exploration\.yml@v1\.3\.5'
        ...
        $script:manualExplorationWorkflow | Should -Match 'platform_ref:\s+v1\.3\.5'
    ...
    It 'documents the target catalog and action-owned public outputs' {
        ...
        $script:docs | Should -Match 'LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/manual-vi-exploration\.yml@v1\.3\.5'
