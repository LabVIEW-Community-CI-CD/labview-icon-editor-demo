...
Describe 'CompareVI History workflow contracts' {
    ...
    It 'adds a thin automatic PR diagnostics wrapper pinned to an immutable comparevi-history ref' {
        ...
        $script:automaticPrWorkflow | Should -Not -Match '(?m)^\s*-\s+main\s*$'
        $script:automaticPrWorkflow | Should -Match 'types:\s*(?:\r?\n\s*-\s+opened)(?:\r?\n\s*-\s+synchronize)(?:\r?\n\s*-\s+reopened)(?:\r?\n\s*-\s+ready_for_review)'
        $script:automaticPrWorkflow | Should -Match 'uses:\s+LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/pull-request-diagnostics-auto\.yml@v1\.3\.24'
        ...
        $script:automaticPrWorkflow | Should -Match 'platform_ref:\s+v1\.3\.24'
    ...
    It 'adds a thin automatic PR publication wrapper pinned to the same immutable comparevi-history ref' {
        ...
        $script:automaticPrPublishWorkflow | Should -Match 'contents:\s+write'
        ...
        $script:automaticPrPublishWorkflow | Should -Match 'uses:\s+LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/pull-request-diagnostics-publish\.yml@v1\.3\.24'
        ...
        $script:automaticPrPublishWorkflow | Should -Match 'platform_ref:\s+v1\.3\.24'
    ...
    It 'adds a thin agent-canary evaluation wrapper pinned to the same immutable comparevi-history ref' {
        ...
        $script:agentCanaryWorkflow | Should -Match 'uses:\s+LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/pull-request-diagnostics-canary-evaluate\.yml@v1\.3\.24'
        ...
        $script:agentCanaryWorkflow | Should -Match 'platform_ref:\s+v1\.3\.24'
        $script:agentCanaryWorkflow | Should -Not -Match '(?m)^\s*artifact_name:\s*$'
    ...
    It 'documents the target catalog and action-owned public outputs' {
        ...
        $script:docs | Should -Match 'pull_request` for `develop`, `release/\*`, `feature/\*`, and `hotfix/\*`'
        ...
        $script:docs | Should -Match 'LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/pull-request-diagnostics-auto\.yml@v1\.3\.24'
        $script:docs | Should -Match 'LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/pull-request-diagnostics-publish\.yml@v1\.3\.24'
        $script:docs | Should -Match 'LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/pull-request-diagnostics-canary-evaluate\.yml@v1\.3\.24'
        $script:docs | Should -Match 'LabVIEW-Community-CI-CD/comparevi-history/\.github/workflows/manual-vi-exploration\.yml@v1\.3\.7'
        $script:docs | Should -Match 'LabVIEW-Community-CI-CD/comparevi-history@v1\.3\.24'
        ...
        $script:docs | Should -Match 'Local-First Maintainer Loop'
        $script:docs | Should -Match 'Invoke-CompareVIHistoryLocalReview\.ps1'
        $script:docs | Should -Match 'dev-fast'
        $script:docs | Should -Match 'warm-dev'
        $script:docs | Should -Match 'Profile proof'
        $script:docs | Should -Match 'history:local:warm-runtime'
        $script:docs | Should -Match 'publication and\s+trust-boundary proof surfaces'
