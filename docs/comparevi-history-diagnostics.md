...
- [`.github/workflows/comparevi-history-pull-request-diagnostics.yml`](../.github/workflows/comparevi-history-pull-request-diagnostics.yml)
  ...
  `LabVIEW-Community-CI-CD/comparevi-history/.github/workflows/pull-request-diagnostics-auto.yml@v1.3.18`.
- [`.github/workflows/comparevi-history-pull-request-diagnostics-publish.yml`](../.github/workflows/comparevi-history-pull-request-diagnostics-publish.yml)
  ...
  `LabVIEW-Community-CI-CD/comparevi-history/.github/workflows/pull-request-diagnostics-publish.yml@v1.3.18`.
- [`.github/workflows/comparevi-history-agent-canary-evaluate.yml`](../.github/workflows/comparevi-history-agent-canary-evaluate.yml)
  ...
  `LabVIEW-Community-CI-CD/comparevi-history/.github/workflows/pull-request-diagnostics-canary-evaluate.yml@v1.3.18`.
...
- consumes the released `LabVIEW-Community-CI-CD/comparevi-history@v1.3.18` platform surface through the reusable
...
- The automatic changed-VI PR wrappers pin the released reusable workflow surface and `platform_ref` to `v1.3.18`.
- The agent-canary evaluation wrapper pins the released reusable workflow surface and `platform_ref` to `v1.3.18`.
