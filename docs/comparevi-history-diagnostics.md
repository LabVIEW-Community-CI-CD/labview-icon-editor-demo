...
- pins the immutable reusable workflow
  `LabVIEW-Community-CI-CD/comparevi-history/.github/workflows/manual-vi-exploration.yml@v1.3.1`
- keeps `platform_ref` aligned with the workflow pin at `v1.3.1`
